...
class OnboardingFeedbackPage extends StatelessWidget {
  const OnboardingFeedbackPage({super.key});
      ...
      body: Container(
        decoration: const BoxDecoration(
          image: DecorationImage(
            image: AssetImage(AppIcons.icOnboarding2),
            fit: BoxFit.cover,
          ),
        ),
        child: SafeArea(
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                // Description
                const Text(
                  'Receive detailed analysis on your facial expressions, '
                  'voice tone, and content quality',
                  style: TextStyle(
